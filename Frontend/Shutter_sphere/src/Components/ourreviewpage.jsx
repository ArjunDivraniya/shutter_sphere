...
const Reviews = () => {
  ...
  return (
    ...
    <div className="p-6 bg-gray-900">
      ...
      {/* Reviews Section */}
      <h2 className="text-white text-2xl font-bold mb-4 text-center">Client & Photographer Reviews</h2>
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {reviews.map((review) => (
            ...
            >
              {review.profilePhoto ? (
                <img src={review.profilePhoto} alt="Profile" className="w-12 h-12 rounded-full mb-2" />
              ) : (
