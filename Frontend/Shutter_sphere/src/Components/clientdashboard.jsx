    ...
    switch (activeMenu) {
      case "overview":
        return <OverviewSection 
                  ...
                  recentActivity={[]} // Backend can provide this if needed
      ...
      case "search":
        return <SearchSection 
                  ...
                  startChatFromCommunity={(name) => {
                     // Logic to find thread or create new
                     setActiveMenu("chat");
                  }} 
                  navigate={navigate}
               />;
      case "bookings":
        return <BookingsSection bookings={dashboardData.bookings} navigate={setActiveMenu} />;
      case "favorites":
      ...
      default:
        return <OverviewSection stats={dashboardData.stats} bookings={dashboardData.bookings} />;
    }
  };
